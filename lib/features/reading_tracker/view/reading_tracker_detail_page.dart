...
class ReadingTrackerDetailPage extends ConsumerWidget {
  ...
  SingleChildScrollView _buildPage(
    ...
    AsyncValue<List<ReadingSessionModel>> readingSessionsAsync,
  ) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(book.publisher, style: context.textTheme.bodyMedium),
                    Text(
          ...
          // Total Reading Time
          Text('Total Time Spent Reading', style: context.textTheme.titleLarge),
          const SizedBox(height: 8),
          Text(
          ...
          Text('Reading Sessions History', style: context.textTheme.titleLarge),
          const SizedBox(height: 16),
